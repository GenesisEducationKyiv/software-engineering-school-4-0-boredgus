...
import (
	mailing "github.com/GenesisEducationKyiv/software-engineering-school-4-0-boredgus/service/dispatch/internal/mailing"
...
func (_m *Mailman) Send(email mailing.Email) error {
	ret := _m.Called(email)
...
func (_c *Mailman_Send_Call) Run(run func(email mailing.Email)) *Mailman_Send_Call {
