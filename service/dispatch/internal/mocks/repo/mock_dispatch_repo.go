...
func (_m *DispatchRepo) GetAllDispatches(ctx context.Context) ([]repo.DispatchData, error) {
	ret := _m.Called(ctx)
...
func (_c *DispatchRepo_GetAllDispatches_Call) Return(_a0 []repo.DispatchData, _a1 error) *DispatchRepo_GetAllDispatches_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *DispatchRepo_GetAllDispatches_Call) RunAndReturn(run func(context.Context) ([]repo.DispatchData, error)) *DispatchRepo_GetAllDispatches_Call {
	_c.Call.Return(run)
	return _c
}
