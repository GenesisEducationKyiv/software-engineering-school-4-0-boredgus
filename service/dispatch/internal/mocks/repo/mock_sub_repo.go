...
func (_m *SubRepo) GetStatusOfSubscription(ctx context.Context, args service.SubscriptionData) (entities.SubscriptionStatus, error) {
	ret := _m.Called(ctx, args)
	...
	var r0 entities.SubscriptionStatus
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, service.SubscriptionData) (entities.SubscriptionStatus, error)); ok {
		return rf(ctx, args)
	}
	if rf, ok := ret.Get(0).(func(context.Context, service.SubscriptionData) entities.SubscriptionStatus); ok {
		r0 = rf(ctx, args)
	} else {
		r0 = ret.Get(0).(entities.SubscriptionStatus)
	}
...
func (_c *SubRepo_GetStatusOfSubscription_Call) Return(_a0 entities.SubscriptionStatus, _a1 error) *SubRepo_GetStatusOfSubscription_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *SubRepo_GetStatusOfSubscription_Call) RunAndReturn(run func(context.Context, service.SubscriptionData) (entities.SubscriptionStatus, error)) *SubRepo_GetStatusOfSubscription_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateSubscriptionStatus provides a mock function with given fields: ctx, args, status
func (_m *SubRepo) UpdateSubscriptionStatus(ctx context.Context, args service.SubscriptionData, status entities.SubscriptionStatus) error {
...
func (_c *SubRepo_UpdateSubscriptionStatus_Call) Run(run func(ctx context.Context, args service.SubscriptionData, status entities.SubscriptionStatus)) *SubRepo_UpdateSubscriptionStatus_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(service.SubscriptionData), args[2].(entities.SubscriptionStatus))
	})
	return _c
}
...
func (_c *SubRepo_UpdateSubscriptionStatus_Call) RunAndReturn(run func(context.Context, service.SubscriptionData, entities.SubscriptionStatus) error) *SubRepo_UpdateSubscriptionStatus_Call {
	_c.Call.Return(run)
	return _c
}
