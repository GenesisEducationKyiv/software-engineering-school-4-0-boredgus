...
func (_m *DispatchService) GetAllDispatches(ctx context.Context) ([]repo.DispatchData, error) {
	ret := _m.Called(ctx)
	...
	var r0 []repo.DispatchData
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) ([]repo.DispatchData, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) []repo.DispatchData); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]repo.DispatchData)
		}
	}
...
func (_c *DispatchService_GetAllDispatches_Call) Return(_a0 []repo.DispatchData, _a1 error) *DispatchService_GetAllDispatches_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *DispatchService_GetAllDispatches_Call) RunAndReturn(run func(context.Context) ([]repo.DispatchData, error)) *DispatchService_GetAllDispatches_Call {
	_c.Call.Return(run)
	return _c
}
