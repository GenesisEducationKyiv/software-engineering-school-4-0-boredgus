...
func (_m *DispatchService) SubscribeForDispatch(ctx context.Context, email string, dispatchId string) error {
...
//   - email string
//   - dispatchId string
func (_e *DispatchService_Expecter) SubscribeForDispatch(ctx interface{}, email interface{}, dispatchId interface{}) *DispatchService_SubscribeForDispatch_Call {
	return &DispatchService_SubscribeForDispatch_Call{Call: _e.mock.On("SubscribeForDispatch", ctx, email, dispatchId)}
}

func (_c *DispatchService_SubscribeForDispatch_Call) Run(run func(ctx context.Context, email string, dispatchId string)) *DispatchService_SubscribeForDispatch_Call {
...
// UnsubscribeFromDispatch provides a mock function with given fields: ctx, email, dispatchId
func (_m *DispatchService) UnsubscribeFromDispatch(ctx context.Context, email string, dispatchId string) error {
	ret := _m.Called(ctx, email, dispatchId)
...
//   - email string
//   - dispatchId string
func (_e *DispatchService_Expecter) UnsubscribeFromDispatch(ctx interface{}, email interface{}, dispatchId interface{}) *DispatchService_UnsubscribeFromDispatch_Call {
	return &DispatchService_UnsubscribeFromDispatch_Call{Call: _e.mock.On("UnsubscribeFromDispatch", ctx, email, dispatchId)}
}

func (_c *DispatchService_UnsubscribeFromDispatch_Call) Run(run func(ctx context.Context, email string, dispatchId string)) *DispatchService_UnsubscribeFromDispatch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string))
	})
	return _c
