...
func (_m *CurrencyService) Convert(ctx context.Context, params services.ConvertCurrencyParams) (map[string]float64, error) {
...
func (_c *CurrencyService_Convert_Call) RunAndReturn(run func(context.Context, services.ConvertCurrencyParams) (map[string]float64, error)) *CurrencyService_Convert_Call {
	_c.Call.Return(run)
	return _c
}
